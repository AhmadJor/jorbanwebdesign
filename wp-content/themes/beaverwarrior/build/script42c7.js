 ...
 * ©2014 JorbanDesigns All Rights Reserved
 */
...
(function (root, factory) {
    ...
    return module;
}));;;// (window.HomePageAnimations = function ($, Behaviors) {
    
//     "use strict";
    
//     var module = {};
 
//     function HomePageAnimations(elem) {
//      // const THREE = require('three');
//         Behaviors.init(HomePageAnimations, this, arguments);
...
//     Behaviors.inherit(HomePageAnimations, Behaviors.Behavior);
 
//     HomePageAnimations.QUERY = "[data-hpanimation]";
 
//     Behaviors.register_behavior(HomePageAnimations);
 
//     module.HomePageAnimations = HomePageAnimations;
 
//     return module;
 
//  }(window.jQuery, window.Behaviors));;"use strict";

(function ($) {

    if ($('.HueSolarSystem').length > 0) {

        var HueSS = $('.HueSolarSystem'),
            zoom = HueSS.data('zoom'),
            mobileZoom = HueSS.data('mobile-zoom'),
            newZoom = zoom;
        ...
        function zoomCalc() {
            ...
            if (windowWidth > 767) {
                newZoom = parseFloat(zoom / 1920 * windowWidth) < 1.31 ? parseFloat(zoom / 1920 * windowWidth) : 1.3;
            } else {
                newZoom = parseFloat(mobileZoom / 991 * windowWidth);
            }

            HueSS.css('transform', 'scale(' + newZoom + ')');

            if (!HueSS.hasClass('HueSolarSystem--show')) {
                HueSS.addClass('HueSolarSystem--show')
            }
        }

        $(window).on('load resize', zoomCalc);
    }
})(jQuery);;/*global define, console, document, window, Promise*/
(function (root, factory) {
    "use strict";
    if (typeof define === 'function' && define.amd) {
...
}(window.jQuery, window.Behaviors));;window.Jorban= window.Jorban|| {};
